...
public class postgresql {
    ...
    private final String postgresql_url = "postgres://hpkmourdokyitg:385268bfad6244b6512f5c88c254b87fe8efd8f22f3bcb86dd4f33e14c4f134a@ec2-54-204-128-96.compute-1.amazonaws.com:5432/d4h4k0j9uun7dk";
    ...
    private postgresql() {
        try {
            ...
            conn = DriverManager.getConnection(postgresql_url);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
